...
function initMap() {
  try {
    ...
    const tileLayerOptions = {
      ...
      keepBuffer: mapConfig.adaptiveTileLoading ? 8 : 5, // Enhanced buffer for smoother panning
    ...
    const tileLayer = L.tileLayer(mapConfig.tileLayer, tileLayerOptions).addTo(map);
